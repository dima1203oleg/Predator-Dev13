...
class PDFParser:
    ...
    def __init__(
        self, ocr_enabled: bool = True, table_detection: bool = True, text_extraction: bool = True
    ):
        ...
        if self.ocr_enabled:
            try:
                ...
                pytesseract.pytesseract.tesseract_cmd = (
                    "/usr/bin/tesseract"  # Adjust path as needed
                )
            except ImportError:
    ...
    def parse(
        self, file_path: str, progress_callback: Callable[[int, int], None] | None = None
    ) -> dict[str, Any]:
        """
        Parse PDF file
        ...
        try:
            with pdfplumber.open(file_path) as pdf:
                ...
                return {"tables": tables, "text": text, "images": images, "metadata": metadata}

        except Exception as e:
            logger.error(f"PDF parsing failed: {e}")
            return {"tables": [], "text": "", "images": [], "metadata": {"error": str(e)}}
                ...
                for img_idx, img in enumerate(page_images):
                    try:
                        ...
                        if self.ocr_enabled:
                            ...
                            ocr_text = pytesseract.image_to_string(pil_image, lang="ukr+eng")
    ...
    def convert_to_records(
        self, parse_result: dict[str, Any], source_file: str
    ) -> list[dict[str, Any]]:
        """
