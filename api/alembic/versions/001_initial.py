...
def upgrade():
    ...
    op.create_index('idx_osint_entities_gin', 'osint_logs', ['ner_entities'], postgresql_using='gin')
    ...
    op.create_index('idx_ts_dimensions', 'timeseries_records', ['dimensions'], postgresql_using='gin')
